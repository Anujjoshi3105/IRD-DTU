    ...
    <a href={link} target="_blank">
      <figure className="flex rounded-lg border-2 hover:shadow-lg items-center mb-4">
        ...
        <div className="text-center mx-auto">
          <blockquote className="md:text-xl font-bold text-slate-800 pb-1">
            {name}
          </blockquote>
          <figcaption className="text-sm font-semibold md:text-base text-slate-700 pb-2 md:pb-6">
            {title}
          </figcaption>
          <figcaption className="text-sm md:text-base md:font-medium">
            <div className="text-slate-700 font-semibold md:font-bold">
              Telephone:
              <span className="text-slate-500 md:text-base md:font-medium pl-2">
                {telephone}
              </span>
            </div>
            <div className="text-slate-700 font-semibold md:font-bold">
